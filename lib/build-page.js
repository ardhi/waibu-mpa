...
async function buildPage ({ text, locals = {}, opts = {} } = {}) {
  ...
  if (!opts.theme) return alert.call(this, text, req.t('Warning: no theme provided!'))
  const theme = find(this.themes, { name: opts.theme })
  if (!theme) return alert.call(this, text, req.t('Warning: unknown theme \'%s\'. Make sure it\'s already loaded', req.theme))
  ...
  await mutation.call(this, { $, el: $.root(), req })
  await replaceTag.call(this, { el: $.root(), cmp: await theme.createComponent({ $, iconset, req, reply, locals }) })
  text = applyInclude.call(this, $)
  $ = cheerio.load(text, this.config.cheerio.loadOptions, false)
  await injectElements.call(this, { $, theme, iconset, req })
