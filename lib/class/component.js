...
class Component {
  ...
  async getBuilder (method) {
    ...
    if (!isClass(Builder)) Builder = await Builder(this)
    return Builder
  }
  ...
  async render (params = {}) {
    ...
    if (!params.noTag) {
      ...
      const method = this.getMethod(params)
      if (this.factory[method] && this.factory[method].after) { // static method on Builder
        html = (await this.factory[method].after.call(this, merge({}, params, { result: html }))) ?? html
      }
