...
class Component {
  ...
  async buildTag (params = {}, opts = {}) {
    ...
    this.builder = new Builder({ component: this, params })
    const resp = await this.builder.build()
  ...
  async render (params = {}) {
    ...
    if (!params.noTag) {
      ...
      if (this.builder && this.builder.after) {
        html = (await this.builder.after(merge({}, params, { result: html }))) ?? html
      }
